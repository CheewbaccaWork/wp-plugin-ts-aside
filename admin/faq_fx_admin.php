...
<div class="wrap">  
        ...
        <table class="form-table" role="presentation">
            <tbody>
                <tr>
                    ...
                    <td>
                        <input type="hidden" value="FAQFX" name="page">
    ...
    <form method="post" action="" class="tradesmarter-aside-admin">
        <table class="form-table" role="presentation">
            <tbody> 
                <?php 
                    $questions = json_decode($result[0]->questions_fx, true);
                    $answers = json_decode($result[0]->answers_fx, true);
                    $count = 1;
                    if ($questions[0]){
                        ...
                        <tr class="faq" data-num="<?php echo $count ?>">
                            ...
                            <td>
                                <input type="text" name="questions_fx[]" class="questions" placeholder="Question" value="<?php echo $questions[$i] ?>">
                                <textarea name="answers_fx[]" cols="30" rows="10"><?php echo $answers[$i] ?></textarea>
                        ...
                        <tr class="faq" data-num="<?php echo $count ?>">
                            ...
                            <td>
                                <input type="text" name="questions_fx[]" class="questions" placeholder="Question">
                                <textarea name="answers_fx[]" cols="30" rows="10"></textarea>
                                <a href="#" title="Add Menu Item" class="addQuestion">+</a>
                                <a href="#" title="Remove Menu Item" class="minusQuestion">-</a>
                            </td>
                        </tr>
